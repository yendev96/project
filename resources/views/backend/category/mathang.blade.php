...
<div class="content" ng-controller="mathangController">
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading myheading">
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <h4><i class="fa fa-folder"></i>QUẢN LÝ MẶT HÀNG<span class="count"></span></h4>
                </div>
                    ...
                    <div class="col-md-3 col-sm-7 col-xs-12  pull-right">
                        <div class="row search">
                            <form action="" method="get" role="form">
                                <input type="text" class="form-control" name="s" placeholder="Tìm kiếm thành viên..." ng-model="search" ng-keyup="searchMh()">
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <form id="formCat" name="formCat" action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name" ng-model="mathang.name" ng-required="true" value="{{old('name')}}" placeholder="Nhập tên danh mục" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="keywords" ng-model="mathang.keywords" placeholder="Nhập từ khóa" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail" class="col-sm-3 control-label">Mô tả</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="description" ng-model="mathang.description" placeholder="Nhập mô tả" ></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_category" class="form-control" ng-model="mathang.id_category" ng-required="true">
...
@section('script')
<script type="text/javascript" src="{{asset('/public/backend/js/angular/mathang.js')}}"></script>
@endsection
