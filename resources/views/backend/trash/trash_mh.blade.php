...
<div class="content" ng-controller="mhTrashController">
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading myheading">
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <h4><i class="fa fa-folder"></i>MẶT HÀNG ĐÃ XÓA<span class="count"></span></h4>
                </div>
                    ...
                    <table id="example2" class="table table-hover table-bordered tbl-admin">
                        <thead>
                            <tr>
                                ...
                                <th ng-click="sortData('name')">Tên</th>
                                <th ng-click="sortData('parent_name')">Thuộc danh mục</th>
                                <th>Action</th>

                            </tr>
                        </thead>
                        <tbody>
                            <tr class="" ng-repeat="x in trashMh | orderBy:sortColumn:reverse | orderBy: '-id'">
                                <td><input id='checkbox' type="checkbox" value=""></td>
                                <td>{%x.name%}</td>
                                <td>{%x.parent_name%}</td>
                                <td class="td-action" class="td-action">
                                    <a data-toggle="tooltip" title="Khôi phục danh mục này" href="" ng-click="modalMh('recovery', x.id)"><i class="fa fa-refresh"></i></a>
                                    <a data-toggle="tooltip" title="Xóa vĩnh viễn" href="" ng-click="modalMh('delete', x.id)"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        </tbody>
